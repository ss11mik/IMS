...
Ve výchozím modelu jsou pracoviště \uv{řezání přírubových profilů} a \uv{kontrola kvality} nejméně využita - na 24, resp. 29 \%. Při snížení jejich   kapacity na polovinu jsou stále využity jen na 47 a 59 \%. Z toho vyplývá, že zaměstnanci na těchto stanovištích mohou pracovat na poloviční úvazek - za udržení produktivity výroby a navýšení průměrného času na jednu trubku na minut.
